...
<details><summary>[9] NotoSansOgham-Regular.ttf</summary>
<div>
<details>
...
* ⚠️ **WARN** <p>Family metadata at fonts/NotoSansOgham/googlefonts/ttf does not have an article.</p>
 [code: lacks-article]
...
<li>U+0307 COMBINING DOT ABOVE: try adding one of: tifinagh, syriac, tai-le, canadian-aboriginal, todhri, math, coptic, hebrew, duployan, malayalam, old-permic</li>
...
<p>Or you can add the above codepoints to one of the subsets supported by the font: <code>latin</code>, <code>latin-ext</code>, <code>ogham</code></p>
...
<p>Your font does <em>not</em> cover the following languages that require the soft-dotted feature: Belarusian (Cyrl, 10,064,517 speakers), South Central Banda (Latn, 244,000 speakers), Lugbara (Latn, 2,200,000 speakers), Fur (Latn, 1,230,163 speakers), Koonzime (Latn, 40,000 speakers), Igbo (Latn, 27,823,640 speakers), Mfumte (Latn, 79,000 speakers), Bafut (Latn, 158,146 speakers), Mundani (Latn, 34,000 speakers), Cicipu (Latn, 44,000 speakers), Aghem (Latn, 38,843 speakers), Kom (Latn, 360,685 speakers), Kaska (Latn, 125 speakers), Nateni (Latn, 100,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Yala (Latn, 200,000 speakers), Southern Kisi (Latn, 360,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Ebira (Latn, 2,200,000 speakers), Mango (Latn, 77,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Basaa (Latn, 332,940 speakers), Bete-Bendi (Latn, 100,000 speakers), Heiltsuk (Latn, 300 speakers), Avokaya (Latn, 100,000 speakers), Ekpeye (Latn, 226,000 speakers), Dii (Latn, 71,000 speakers), Teke-Ebo (Latn, 260,000 speakers), Gulay (Latn, 250,478 speakers), Vute (Latn, 21,000 speakers), Ma’di (Latn, 584,000 speakers), Navajo (Latn, 166,319 speakers), Dan (Latn, 1,099,244 speakers), Zapotec (Latn, 490,000 speakers), Ejagham (Latn, 120,000 speakers), Makaa (Latn, 221,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Sar (Latn, 500,000 speakers), Han (Latn, 6 speakers), Nzakara (Latn, 50,000 speakers).</p>
 [code: soft-dotted]
...
<pre><code>* uni1698 (U+1698): X=332.0,Y=-1.0 (should be at baseline 0?)

* uni1698 (U+1698): X=257.0,Y=-1.0 (should be at baseline 0?)
...
* acircumflex (U+00E2): X=279.0,Y=696.0 (should be at cap-height 695?)
...
* circumflex (U+02C6): X=207.0,Y=696.0 (should be at cap-height 695?)

* uni0302 (U+0302): X=0.0,Y=696.0 (should be at cap-height 695?)

* colon (U+003A): X=177.5,Y=2.0 (should be at baseline 0?)

* colon (U+003A): X=90.0,Y=2.0 (should be at baseline 0?)

* copyright (U+00A9): X=269.0,Y=697.0 (should be at cap-height 695?)

* copyright (U+00A9): X=558.5,Y=697.0 (should be at cap-height 695?)
...
* ecircumflex (U+00EA): X=283.0,Y=696.0 (should be at cap-height 695?)
...
* eth (U+00F0): X=342.0,Y=693.0 (should be at cap-height 695?)
...
* f (U+0066): X=284.0,Y=693.0 (should be at cap-height 695?)

* germandbls (U+00DF): X=317.0,Y=-1.0 (should be at baseline 0?)

* h (U+0068): X=173.0,Y=537.0 (should be at x-height 536?)

* icircumflex (U+00EE): X=127.0,Y=696.0 (should be at cap-height 695?)

* ocircumflex (U+00F4): X=301.0,Y=696.0 (should be at cap-height 695?)

* oe (U+0153): X=791.0,Y=-1.5 (should be at baseline 0?)

* ordfeminine (U+00AA): X=52.0,Y=693.0 (should be at cap-height 695?)
...
* registered (U+00AE): X=269.0,Y=697.0 (should be at cap-height 695?)

* registered (U+00AE): X=558.5,Y=697.0 (should be at cap-height 695?)
...
* section (U+00A7): X=261.0,Y=697.0 (should be at cap-height 695?)

* three (U+0033): X=137.0,Y=-1.5 (should be at baseline 0?)

* ucircumflex (U+00FB): X=307.0,Y=696.0 (should be at cap-height 695?)
...
* wcircumflex (U+0175): X=391.0,Y=696.0 (should be at cap-height 695?)
...
* ycircumflex (U+0177): X=253.0,Y=696.0 (should be at cap-height 695?)
...
<pre><code>* uni1685 (U+1685) contains a short segment L&lt;&lt;0.0,281.0&gt;--&lt;0.0,314.0&gt;&gt;

* uni1685 (U+1685) contains a short segment L&lt;&lt;911.0,314.0&gt;--&lt;911.0,281.0&gt;&gt;

* uni168A (U+168A) contains a short segment L&lt;&lt;0.0,281.0&gt;--&lt;0.0,314.0&gt;&gt;

* uni168A (U+168A) contains a short segment L&lt;&lt;911.0,314.0&gt;--&lt;911.0,281.0&gt;&gt;

* uni168D (U+168D) contains a short segment L&lt;&lt;0.0,281.0&gt;--&lt;0.0,314.0&gt;&gt;

* uni168D (U+168D) contains a short segment L&lt;&lt;623.0,314.0&gt;--&lt;623.0,281.0&gt;&gt;

* uni168E (U+168E) contains a short segment L&lt;&lt;0.0,281.0&gt;--&lt;0.0,314.0&gt;&gt;

* uni168E (U+168E) contains a short segment L&lt;&lt;767.0,314.0&gt;--&lt;767.0,281.0&gt;&gt;

* uni168F (U+168F) contains a short segment L&lt;&lt;0.0,281.0&gt;--&lt;0.0,314.0&gt;&gt;

* uni168F (U+168F) contains a short segment L&lt;&lt;911.0,314.0&gt;--&lt;911.0,281.0&gt;&gt;
